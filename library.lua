...
menu.outline.outline.main.text.Text = "skeet"
...
function library:saveConfig()
    ...
    writefile("skeet/"..tostring(game.GameId).."/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("skeet/"..tostring(game.GameId).."/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("skeet/"..tostring(game.GameId).."/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("skeet/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("skeet/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg") then
        delfile("skeet/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
