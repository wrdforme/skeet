...
if not isfolder("skeet/"..tostring(game.GameId)) then
    makefolder("skeet/"..tostring(game.GameId))
end
--vars
local library,menu,tabholder = loadstring(game:HttpGet("https://raw.githubusercontent.com/wrdforme/skeet/refs/heads/main/library.lua"))()
...
local skeetWatermark = Drawing.new("Text");skeetWatermark.Font = Drawing.Fonts.Plex;skeetWatermark.Position = Vector2.new(50,24);skeetWatermark.Visible = false;skeetWatermark.Size = 16;skeetWatermark.Color = Color3.new(1,1,1);skeetWatermark.Outline = true
...
function onStep()
    ...
    if library.flags["watermark_enabled"] then
        ...
        skeetWatermark.Text = "skeet | "..ver.." | "..hours..":"..minutes..":"..seconds
    end
end
